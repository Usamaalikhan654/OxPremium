    ...
    <div className="card-body">
      <form action="/" onSubmit={(e) => this.handleSubmit(e)} encType="multipart/form-data" autoComplete="off">
        <div className="form-group">
          ...
          <input name="name" type="text" className="form-control coloring" placeholder="Your Name" value={this.state.name} onChange={this.handleChange} onBlur={this.handleBlur} />
          { nameError
        ...
        <div className="form-group">
          ...
          <input name="email" type="email" className="form-control coloring" placeholder="Your Email" value={this.state.email} onChange={this.handleChange} onBlur={this.handleBlur} />
          { emailError
        ...
        <div className="form-group">
          ...
          <input name="subject" type="text" className="form-control coloring" placeholder="Your subject" onChange={this.handleChange} value={this.state.subject}  />
        </div>
        <div className="form-group">
          {/* <label className="mb-0">Message<span className="text-danger">*</span></label> */}
          <textarea name="message" type="text" className="form-control coloring" placeholder="Your Message" value={this.state.message} onChange={this.handleChange} onBlur={this.handleBlur} />
          { messageError
            ? <div className="alert alert-danger mt-2">Message is a required field.</div>
            : ''
          }
        </div>
          <p className="text-center mb-0"><input type="submit" className=" btn btn-outline-success  text-center" value="Send" /></p>
      </form>
