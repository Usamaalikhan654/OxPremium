          ...
          <div className="container">
            ...
            <div className="row Fi-region">
              <div className="col-lg-6 page-text">
                <p>Safety is the core concern of all the responsible organizations and institutions and we understand the lack of available trainings and facilitation for it. This requirement made us work on a full-scale safety trainings and consultancies so that we furnish your need and resolve it fully with our local and cultural knowledge and limitations.<br /><br />
              ...
              <div className="col-lg-6 page-image">
                <img src="./images/web opt 2-30 1.png" className="img-fluid" width="400px" height="300px" />
              </div>
            </div>
          </div>
        </div>
